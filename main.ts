...
//  Animations 
let knight_run_right = animation.createAnimation(animation._actionEnumShim(0), 100)
...
let knight_idle = animation.createAnimation(animation._actionEnumShim(1), 750)
...
game.onUpdate(function on_update() {
    ...
    if (knight.vx > 0) {
        ...
        //  elif knight.vx < 0:
        animation.setAction(knight, animation._actionEnumShim(1))
    }
...
let door = sprites.create(img`
    ...
    . . c f b e e e e e e e e 1 . .
`, SpriteKind.doorway)
tiles.placeOnTile(door, tiles.getTileLocation(49, 8))
sprites.onOverlap(SpriteKind.Player, SpriteKind.doorway, function on_overlap4(sprite: Sprite, otherSprite: Sprite) {
