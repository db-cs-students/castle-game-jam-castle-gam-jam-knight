...
# Animations 
knight_run_right = animation.create_animation(animation._action_enum_shim(0), 750)
...
knight_idle = animation.create_animation(animation._action_enum_shim(0), 750)
...
door = sprites.create(img("""
    ...
    . . c f b e e e e e e e e 1 . .
""")) 
scene.place_on_random_tile( door, 1,) 
...
def on_update():
    ...
    # elif knight.vx < 0:
        ...
        animation.run_image_animation(knight,
         ...
         animation.run_image_animation(knight, [img("""
             ....................
             ....................
             ....................
             ....................
