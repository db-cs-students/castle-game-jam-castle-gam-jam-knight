...
# Animations 
knight_run_right = animation.create_animation(animation._action_enum_shim(0), 100)
knight_run_right.add_animation_frame(img("""
        ....................
        ....................
        ....................
        ....................
...
knight_run_right.add_animation_frame(img("""
        ...
        .....ffffffff.......
        """))
animation.attach_animation(knight, knight_run_right)

knight_idle = animation.create_animation(animation._action_enum_shim(1), 750)
...
def on_update():
    ...
    if knight.vx > 0:
        animation.set_action(knight, animation._action_enum_shim(0))
    # elif knight.vx < 0:
    else:
        animation.set_action(knight, animation._action_enum_shim(1))
...
door = sprites.create(img("""
    ...
    . . c f b e e e e e e e e 1 . .
"""), SpriteKind.doorway) 
tiles.place_on_tile(door, tiles.get_tile_location(49, 8)) 

def on_overlap4(sprite, otherSprite):
    game.over(True, effects.smiles)
sprites.on_overlap(SpriteKind.player, SpriteKind.doorway, on_overlap4)